            ...
            >
              <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:px-8">
                <div>
                  ...
                  <h2 className="mt-6 font-display text-[1.9rem] font-semibold sm:text-4xl leading-[1.06] tracking-[-0.03em] text-[#2c3272] lg:text-5xl">
                    {title}
                  </h2>
                  <p className="mt-6 max-w-xl text-base leading-8 text-[#2c3272] sm:text-lg">{description}</p>
                ...
                <div className="lg:pt-4">
                  ...
                  <ul className="mt-6 divide-y divide-[#dcdfeb] border-y border-[#dcdfeb]">
                    {points.map((point) => (
                      <li key={point} className="py-5 text-[17px] leading-7 text-[#2c3272]">
                        {point}
                      </li>
                    ))}
                  </ul>
