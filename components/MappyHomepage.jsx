...
function SectionHeading({ eyebrow, title, description, className = "" }) {
  return (
    <div className={className} data-section-heading>
      ...
      {description ? (
        <p className="mt-6 max-w-3xl text-base leading-8 text-[#2c3272] sm:text-lg">{description}</p>
      ) : null}
    </div>
  );
}
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      heroTimeline
        ...
        .from("[data-ticker]", { autoAlpha: 0, y: 16, duration: 0.7 }, 0.5);
  ...
  return (
    <div ref={rootRef} id="top" className="bg-[#f4f5fc]">
      ...
      <PageMotion>
        <main>
          {/* Hero */}
          <section data-no-motion className="border-b border-[#dcdfeb] bg-white">
            <div className="grid lg:grid-cols-2">
              <div
                data-hero-visual
                className="relative order-1 min-h-[380px] overflow-hidden sm:min-h-[460px] lg:order-2 lg:min-h-[680px]"
              >
                <Image
                  data-hero-parallax
            ...
            <div data-ticker className="overflow-hidden bg-[#ed6929] py-4">
                ...
                {heroSignals.map(({ title, description, icon: Icon }) => (
                  <div key={title} data-hero-signal className="flex gap-4 py-8 lg:px-8 lg:first:pl-0 lg:last:pr-0">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-[#2c3272]">{description}</p>
                    </div>
                  </div>
                ))}
              </div>
